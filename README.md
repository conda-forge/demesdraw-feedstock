...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/demesdraw-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13530&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/demesdraw-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `demesdraw` can be installed with:

```
conda install demesdraw
```

It is possible to list all of the versions of `demesdraw` available on your platform with:
